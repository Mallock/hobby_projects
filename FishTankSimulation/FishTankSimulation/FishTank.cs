...
public class FishTank
{
    ...
    public FishTank(int width, int height)
    {
        rand = new Random();
        canvasHeight = height;
        canvasWidth = width;
    ...
    private void InitializeSimulation()
    {
        ...
        fishTypes = new List<FishType>
            {
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources._2427851_fish_fishing_food_sea_sea_creature_icon_right), FishSpeedCategory.Fast),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources._8935917_aquarium_fish_hippocampus_marine_seahorse_icon), FishSpeedCategory.Slow),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.parvi), FishSpeedCategory.Fast),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources._8935924_aquarium_blowfish_fish_puffer_pufferfish_icon), FishSpeedCategory.Slow),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.big_gold_fish), FishSpeedCategory.Medium),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.medusa), FishSpeedCategory.Slow),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.gold_fish), FishSpeedCategory.Fast),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.clown_fish), FishSpeedCategory.Medium),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.surgeon_fish), FishSpeedCategory.Medium),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.angelfish), FishSpeedCategory.Medium),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.sardine), FishSpeedCategory.Medium),
                new FishType(new Bitmap(FishTankSimulation.Properties.Resources.shrimp), FishSpeedCategory.Slow),
            };
        ...
        plantImages = new List<Bitmap>
            {
                new Bitmap(FishTankSimulation.Properties.Resources._8936057_algae_bloom_cladophora_seaweed_underwater_icon),
                new Bitmap(FishTankSimulation.Properties.Resources._8935921_algae_bloom_cladophora_seaweed_underwater_icon),
                new Bitmap(FishTankSimulation.Properties.Resources._11823407_game_pearl_shells_blue_pearl_sea_icon),
                new Bitmap(FishTankSimulation.Properties.Resources._8935921_algae_bloom_cladophora_seaweed_underwater_icon),
                new Bitmap(FishTankSimulation.Properties.Resources._8935918_coral_diving_nature_ocean_reef_icon),
                new Bitmap(FishTankSimulation.Properties.Resources._8935918_coral_diving_nature_ocean_reef_icon),
                new Bitmap(FishTankSimulation.Properties.Resources.sea_grass_flip),
                new Bitmap(FishTankSimulation.Properties.Resources.sea_grass),
                new Bitmap(FishTankSimulation.Properties.Resources.sea_leaves),
                new Bitmap(FishTankSimulation.Properties.Resources.sea_leaves_flip),
                new Bitmap(FishTankSimulation.Properties.Resources.algae2),
                new Bitmap(FishTankSimulation.Properties.Resources._11823408_game_castle_prince_princess_building_icon),
                new Bitmap(FishTankSimulation.Properties.Resources.coral_scaled),
                new Bitmap(FishTankSimulation.Properties.Resources.coral_scaled_flip),
                new Bitmap(FishTankSimulation.Properties.Resources.StarFish),
                new Bitmap(FishTankSimulation.Properties.Resources.fishleaves),
                new Bitmap(FishTankSimulation.Properties.Resources.coral1),
                new Bitmap(FishTankSimulation.Properties.Resources.coral2),
                new Bitmap(FishTankSimulation.Properties.Resources.coral3),
            };
        ...
        bubbleImages = new List<Bitmap>
            {
                new Bitmap(FishTankSimulation.Properties.Resources.bubble_1),
                new Bitmap(FishTankSimulation.Properties.Resources.bubble_2),
                new Bitmap(FishTankSimulation.Properties.Resources.bubble_3),
                new Bitmap(FishTankSimulation.Properties.Resources.bubble_4),
                new Bitmap(FishTankSimulation.Properties.Resources.bubble_5),
                new Bitmap(FishTankSimulation.Properties.Resources.bubble_6),
                new Bitmap(FishTankSimulation.Properties.Resources.bubble_7),
            };

        bubbles = new List<Bubble>();

        Bitmap hermitCrabImage = new Bitmap(FishTankSimulation.Properties.Resources.hermit_crab);
    ...
    private void UpdateSimulation()
    {
        ...
        for (int i = foodList.Count - 1; i >= 0; i--)
        {
            ...
            {
                // Before removing food, update fish  
                foreach (var fish in fishList)
                {
                    if (fish.TargetFood == food)
                    {
        ...
        for (int i = fishList.Count - 1; i >= 0; i--)
        {
            ...
            if (!fish.IsDead)
            {
                ...
                if (fish.IsGoingToFood && fish.TargetFood != null)
                {
                    float dx = fish.TargetFood.X - fish.X;
                    float dy = fish.TargetFood.Y - fish.Y;
                    ...
                    if (Math.Abs(fish.X - fish.TargetFood.X) < 5 && Math.Abs(fish.Y - fish.TargetFood.Y) < 5)
                    {
                        fish.IsGoingToFood = false;
                        fish.IsEating = true;
                        fish.EatingTimer = 60;
                        ...
                        foodList.Remove(fish.TargetFood);
                        fish.TargetFood = null;
                    }
                }
                else
